    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"C:\Users\PC\Downloads\OneDrive_2023-11-10\Pertemuan 8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogresult = MessageBox.Show("Apakah anda yakin ingin menghapus data mahasiswa?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
